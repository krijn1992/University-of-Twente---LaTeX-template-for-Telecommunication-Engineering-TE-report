...
% Include big logo
%\node[anchor=north east,inner sep=0pt] at (19.8,-1.2) {\includegraphics[width=156mm]{frontpage/utewi}};

% NOTE: THIS IS THE NEW STYLE
% Include side bar (choose 1-5)
\node[anchor=north west,inner sep=0pt] at (-2,0) {\includegraphics[height=297mm]{frontpage/sidebar3}};
% Include big logo
\node[anchor=north east,inner sep=0pt] at (20.7,-1.2) {\includegraphics[width=150mm]{frontpage/ut}};
...
\textbf{The greatest thing\\since bread came sliced}
\end{center}
\end{minipage}
};
...
\node[inner sep=0pt] at (13,-18) {
	\begin{minipage}{20cm}
		...
		\textbf{\Large{
		Homer J. Simpson\\[1mm]
		B.Sc./M.Sc. Thesis \emph{or} Individual research assignment\\[1mm]
		Month 201X
		}}
		\end{center}
	\end{minipage}
